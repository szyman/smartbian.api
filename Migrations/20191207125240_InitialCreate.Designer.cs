...
namespace SmartRoomsApp.API.Migrations
{
    ...
    [Migration("20191207125240_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartRoomsApp.API.Models.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("SmartRoomsApp.API.Models.UserRole", b =>
                {
                    b.Property<int>("UserId");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("SmartRoomsApp.API.Models.Role")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("SmartRoomsApp.API.Models.User")
                        .WithMany()
            ...
            modelBuilder.Entity("SmartRoomsApp.API.Models.UserRole", b =>
                {
                    b.HasOne("SmartRoomsApp.API.Models.Role", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade);
